...
export const mockCourses: Course[] = [
  { id: 'c1', title: 'Engenharia de Software', code: 'ES01', description: 'Bacharelado em Eng. de Software', instructorId: 't1', coordinatorId: 't1', modality: 'HIBRIDO', degree: 'GRADUACAO', workload: 3200, status: 'PUBLISHED', totalModules: 10, totalStudents: 154, totalClasses: 4, thumbnailUrl: 'https://picsum.photos/seed/web/400/225' },
  { id: 'c2', title: 'Design Gráfico', code: 'DG02', description: 'Tecnólogo em Design Gráfico e Interfaces', instructorId: 't2', coordinatorId: 't2', modality: 'ONLINE', degree: 'GRADUACAO', workload: 2400, status: 'PUBLISHED', totalModules: 8, totalStudents: 89, totalClasses: 2, thumbnailUrl: 'https://picsum.photos/seed/ui/400/225' },
  { id: 'c3', title: 'Sistemas de Informação', code: 'SI03', description: 'Bacharelado com foco em gestão de TI', instructorId: 't3', coordinatorId: 't3', modality: 'PRESENCIAL', degree: 'GRADUACAO', workload: 3000, status: 'ARCHIVED', totalModules: 12, totalStudents: 120, totalClasses: 3, thumbnailUrl: 'https://picsum.photos/seed/soft/400/225' },
  { id: 'c4', title: 'Ciência da Computação', code: 'CC04', description: 'Bacharelado em Ciência da Computação', instructorId: 't1', coordinatorId: 't1', modality: 'HIBRIDO', degree: 'GRADUACAO', workload: 3600, status: 'DRAFT', totalModules: 12, totalStudents: 200, totalClasses: 6, thumbnailUrl: 'https://picsum.photos/seed/comp/400/225' },
];
