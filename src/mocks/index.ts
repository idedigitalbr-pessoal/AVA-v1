...
export const mockCourses: Course[] = [
  { id: 'c1', title: 'Engenharia de Software', description: 'Bacharelado em Eng. de Software', code: 'ENG01', status: 'PUBLISHED', modality: 'PRESENCIAL', degree: 'GRADUACAO', workload: 3200, coordinatorId: 't1', coordinatorName: 'Prof. Carlos Mendes', instructorId: 't1', totalModules: 10, totalStudents: 154, totalClasses: 3, thumbnailUrl: 'https://picsum.photos/seed/web/400/225' },
  { id: 'c2', title: 'Design Gráfico', description: 'Tecnólogo em Design Gráfico e Interfaces', code: 'DES02', status: 'DRAFT', modality: 'HIBRIDO', degree: 'LATO_SENSU', workload: 1200, coordinatorId: 't2', coordinatorName: 'Prof. Julia Rocha', instructorId: 't2', totalModules: 8, totalStudents: 89, totalClasses: 2, thumbnailUrl: 'https://picsum.photos/seed/ui/400/225' },
  { id: 'c3', title: 'Sistemas de Informação', description: 'Bacharelado com foco em gestão de TI', code: 'SIS03', status: 'PUBLISHED', modality: 'EAD', degree: 'GRADUACAO', workload: 3000, coordinatorId: 't3', coordinatorName: 'Prof. Roberto Nogueira', instructorId: 't3', totalModules: 12, totalStudents: 120, totalClasses: 4, thumbnailUrl: 'https://picsum.photos/seed/soft/400/225' },
  { id: 'c4', title: 'Ciência da Computação', description: 'Bacharelado em Ciência da Computação', code: 'COM04', status: 'ARCHIVED', modality: 'PRESENCIAL', degree: 'GRADUACAO', workload: 3600, coordinatorId: 't1', coordinatorName: 'Prof. Carlos Mendes', instructorId: 't1', totalModules: 12, totalStudents: 200, totalClasses: 5, thumbnailUrl: 'https://picsum.photos/seed/comp/400/225' },
];
